...
DECLARE
  ...
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Ind6dmF6Z2FldHdnbnRyZ25qb3Z6Iiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcxMTgwMzk5MSwiZXhwIjoyMDI3Mzc5OTkxfQ.0V0CE5xWk8kvAfVTkgJWgrxg0dhyXuvCAC2V2N0rIM4'; -- full access needed for http request to storage
